...
class Roboclaw:
	...
	def __init__(self, comport, rate, timeout=0.01, retries=3):
		...
		# print(self._port.isOpen())
		# self._port = serial.Serial(port=self.comport,baudrate=self.rate,parity=serial.PARITY_ODD,stopbits=serial.STOPBITS_TWO,bytesize=serial.SEVENBITS)
